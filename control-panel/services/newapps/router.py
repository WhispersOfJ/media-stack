...
NEW_APP_CONTAINERS = ["prefetcharr"]
...
def newapps_status(_=Depends(current_user_or_service)):
    ...
    Tautulli, Wrapperr, Maintainerr, and Lingarr were decommissioned; see PLANS.md."""
    ports = {}
    out = {}
    ...
    msg = "All 1 new app healthy." if not down else f"Problem with: {', '.join(down)}"
