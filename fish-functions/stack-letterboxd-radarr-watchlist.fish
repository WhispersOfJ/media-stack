# Usage: stack-letterboxd-radarr-watchlist <letterboxd-watchlist-url> [--no-search] [--no-monitor] [--limit N] [--dry-run] [--anime]
...
function stack-letterboxd-radarr-watchlist --description 'Add every film in a Letterboxd watchlist to Radarr'
    ...
    if test (count $argv) -ne 1
        echo "Usage: stack-letterboxd-radarr-watchlist <letterboxd-watchlist-url> [--no-search] [--no-monitor] [--limit N] [--dry-run] [--anime]" >&2
        return 1
    end
    set -l url $argv[1]
    set -l search true
