# The Stack — technical reference

> **New here?** Start with [README.md](README.md) instead — a short, plain-language guide to
> getting this stack running. Everything below is the deep technical reference: exact reasoning
> for every image pin, every resource limit, every migration and bug fix, service-by-service.
> Come back here once the basics are working and you want to understand *why* something is the
> way it is, or you're changing something yourself.
