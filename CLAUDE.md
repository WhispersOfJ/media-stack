...
General-purpose rules to reduce common LLM coding mistakes, on top of the stack-specific
rules below. **Tradeoff:** these bias toward caution over speed — for trivial tasks, use
judgment.
